...
var Areaset = (function (_super) {
    ...
    Areaset.prototype.render = function () {
        var _this = this;
        var height = this.config.get('height'), propertyX = this.config.get('propertyX'), propertyY = this.config.get('propertyY');
...
var Linechart = (function (_super) {
    ...
    function Linechart(data, userConfig) {
        ...
        _super.call(this, new SvgStrategyLinechart(), data, userConfig, defaults);
    }
...
var Barchart = (function (_super) {
    ...
    function Barchart(data, userConfig) {
        if (userConfig === void 0) { userConfig = {}; }
        _super.call(this, new SvgStrategyBarchart(), data, userConfig, defaults$1);
    }
...
var Gauge = (function (_super) {
    ...
    function Gauge(data, userConfig) {
        if (userConfig === void 0) { userConfig = {}; }
        _super.call(this, new SvgStrategyGauge(), data, userConfig, defaults$2);
    }
...
var Scatterplot = (function (_super) {
    ...
    function Scatterplot(data, userConfig) {
        if (userConfig === void 0) { userConfig = {}; }
        _super.call(this, new SvgStrategyScatterplot(), data, userConfig, defaults$3);
    }
...
var Streamgraph = (function (_super) {
    ...
    function Streamgraph(data, userConfig) {
        if (userConfig === void 0) { userConfig = {}; }
        _super.call(this, new SvgStrategyStreamgraph(), data, userConfig, defaults$4);
    }
...
var StackedArea = (function (_super) {
    ...
    function StackedArea(data, userConfig) {
        if (userConfig === void 0) { userConfig = {}; }
        _super.call(this, new SvgStrategyStreamgraph(), data, userConfig, defaults$5);
    }
...
var Swimlane = (function (_super) {
    ...
    function Swimlane(data, userConfig) {
        if (userConfig === void 0) { userConfig = {}; }
        _super.call(this, new SvgStrategySwimlane(), data, userConfig, defaults$6);
    }
...
var Sunburst = (function (_super) {
    ...
    function Sunburst(data, userConfig) {
        if (userConfig === void 0) { userConfig = {}; }
        _super.call(this, new SvgStrategySunburst(), data, userConfig, defaults$7);
    }
...
var ZoomComponent = (function (_super) {
    ...
    function ZoomComponent(zoomerComponent) {
        ...
        this.zoom = d3.zoom().scaleExtent([1 / 2, 4]);
    }
...
var Network = (function (_super) {
    ...
    function Network(data, userConfig) {
        if (userConfig === void 0) { userConfig = {}; }
        _super.call(this, new SvgStrategyNetwork(), data, userConfig, defaults$8);
    }
