...
var Legend = (function (_super) {
    ...
    Legend.prototype.toggle = function (d) {
        var key = d.key, element = this.svg.selectAll('g[data-key="' + key + '"]');
        if (!element.empty()) {
...
var SvgStrategyLinechart = (function (_super) {
    ...
    function SvgStrategyLinechart() {
        ...
        _this.lines = new Lineset(_this.axes);
        return _this;
    }
...
var Linechart = (function (_super) {
    ...
    function Linechart(data, userConfig) {
        ...
        return _super.call(this, new SvgStrategyLinechart(), data, userConfig) || this;
    }
...
var Barchart = (function (_super) {
    ...
    function Barchart(data, userConfig) {
        if (userConfig === void 0) { userConfig = {}; }
        return _super.call(this, new SvgStrategyBarchart(), data, userConfig) || this;
    }
...
var Gauge = (function (_super) {
    ...
    function Gauge(data, userConfig) {
        if (userConfig === void 0) { userConfig = {}; }
        return _super.call(this, new SvgStrategyGauge(), data, userConfig) || this;
    }
...
var Scatterplot = (function (_super) {
    ...
    function Scatterplot(data, userConfig) {
        if (userConfig === void 0) { userConfig = {}; }
        return _super.call(this, new SvgStrategyScatterplot(), data, userConfig) || this;
    }
...
var Streamgraph = (function (_super) {
    ...
    function Streamgraph(data, userConfig) {
        if (userConfig === void 0) { userConfig = {}; }
        return _super.call(this, new SvgStrategyStreamgraph(), data, userConfig) || this;
    }
...
var Swimlane = (function (_super) {
    ...
    function Swimlane(data, userConfig) {
        if (userConfig === void 0) { userConfig = {}; }
        return _super.call(this, new SvgStrategySwimlane(), data, userConfig) || this;
    }
...
var Sunburst = (function (_super) {
    ...
    function Sunburst(data, userConfig) {
        if (userConfig === void 0) { userConfig = {}; }
        return _super.call(this, new SvgStrategySunburst(), data, userConfig) || this;
    }
...
var Network = (function (_super) {
    ...
    function Network(data, userConfig) {
        if (userConfig === void 0) { userConfig = {}; }
        return _super.call(this, new SvgStrategyNetwork(), data, userConfig) || this;
    }
