/*
	Rollup.js v0.36.4
	Mon Nov 28 2016 09:49:30 GMT+0100 (CET) - commit fca14dbab102a9fa8efc7249287e2145583712ea
...
function isUsedByBundle$1$1 ( scope, node ) {
...
var AssignmentExpression = (function (Node) {
	...
	AssignmentExpression.prototype.isUsedByBundle = function isUsedByBundle$1 () {
		return isUsedByBundle$1$1( this.scope, this.subject );
	};
...
var Identifier$1 = (function (Node) {
	function Identifier () {
		Node.apply(this, arguments);
	}
...
var UpdateExpression = (function (Node) {
	...
	UpdateExpression.prototype.hasEffects = function hasEffects ( scope ) {
		return isUsedByBundle$1$1( scope, this.subject );
	};
...
function amd ( bundle, magicString, ref, options ) {
	...
	var args = bundle.externalModules.map( getName$1 );
...
function badExports ( option, keys$$1 ) {
	throw new Error( ("'" + option + "' was specified for options.exports, but entry module has following exports: " + (keys$$1.join(', '))) );
}
...
function getIndentString$1 ( magicString, options ) {
...
Bundle$$1.prototype.render = function render ( options ) {
	...
	var indentString = getIndentString$1( magicString, options );
