...
Globals.SLIDE_TRANSITION_TIME = 750;
...
var XAxis = (function (_super) {
    ...
    XAxis.prototype.update = function (data) {
        ...
        if (xAxisType === 'linear') {
            ...
            this.updateDomainByMinMax(min$$1, max$$1 - 1);
        }
    ...
    XAxis.prototype.transition = function (time) {
        ...
        this.svg.selectAll('.x.axis').transition().ease(d3.easeLinear).duration(time).call(this._xAxis);
...
var Lineset = (function (_super) {
    ...
    Lineset.prototype.update = function (data) {
        ...
        series.data(dataSeries, function (d) { return d[propertyKey]; })
            .enter()
            .append('g')
        ...
        var slideDistance = this.x.xAxis.scale()(dataSeries[0].values[dataSeries[0].values.length - 2][propertyX])
            - this.x.xAxis.scale()(dataSeries[0].values[dataSeries[0].values.length - 1][propertyX]);
        window.dataseries = dataSeries;
        lines.data(dataSeries, function (d) { return d[propertyKey]; })
...
var ClipPath = (function (_super) {
    ...
    ClipPath.prototype.update = function (data) {
    };
...
var SvgStrategyLinechart = (function (_super) {
    ...
    SvgStrategyLinechart.prototype.initialize = function () {
        ...
        var markerSize = this.config.get('markerSize'), areaOpacity = this.config.get('areaOpacity'), legend = this.config.get('legend'), width = this.config.get('width'), height = this.config.get('height');
