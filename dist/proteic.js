...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Linechart_1 = __webpack_require__(1);
	exports.Linechart = Linechart_1.default;
	var Barchart_1 = __webpack_require__(25);
	exports.Barchart = Barchart_1.default;
	var Gauge_1 = __webpack_require__(29);
	exports.Gauge = Gauge_1.default;
	var Scatterplot_1 = __webpack_require__(35);
	exports.Scatterplot = Scatterplot_1.default;
	var Streamgraph_1 = __webpack_require__(39);
	exports.Streamgraph = Streamgraph_1.default;
	var StackedArea_1 = __webpack_require__(43);
	exports.StackedArea = StackedArea_1.default;
	var Swimlane_1 = __webpack_require__(45);
	exports.Swimlane = Swimlane_1.default;
	var Sunburst_1 = __webpack_require__(49);
	exports.Sunburst = Sunburst_1.default;
	var Network_1 = __webpack_require__(56);
	exports.Network = Network_1.default;
	var PieChart_1 = __webpack_require__(61);
	exports.PieChart = PieChart_1.default;
	var WebsocketDatasource_1 = __webpack_require__(65);
	exports.WebsocketDatasource = WebsocketDatasource_1.default;
	var HTTPDatasource_1 = __webpack_require__(67);
	exports.HTTPDatasource = HTTPDatasource_1.default;
	var Globals_1 = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SvgStrategyLinechart_1 = __webpack_require__(8);
	var linechart_1 = __webpack_require__(22);
	var functions_1 = __webpack_require__(5);
	var Linechart = (function (_super) {
	    __extends(Linechart, _super);
	    function Linechart(data, userConfig) {
	        if (userConfig === void 0) { userConfig = {}; }
	        return _super.call(this, new SvgStrategyLinechart_1.default(), data, userConfig, linechart_1.defaults) || this;
	    }
	    Linechart.prototype.keepDrawing = function (datum) {
	        var nullValues = this.config.get('nullValues');
	        var maxNumberOfElements = this.config.get('maxNumberOfElements'), numberOfElements = this.data.length, position = -1, datumType = datum.constructor, keys = [
	            this.config.get('propertyX'),
	            this.config.get('propertyY'),
	            this.config.get('propertyKey')
	        ];
	        if (datumType === Array) {
	            var filteredDatum = datum.filter(functions_1.isValuesInObjectKeys(nullValues, keys));
	        ...
	        this.draw(functions_1.copy(this.data));
	    };
	    return Linechart;
	}(Chart_1.default));
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var SvgStrategy_1 = __webpack_require__(3);
	...
	var Chart = (function () {
	    function Chart(strategy, data, userConfig, defaults) {
	        this.ds = null;
	        this.dispatcher = d3_1.dispatch('onmessage', 'onopen', 'onerror', 'addLoading', 'removeLoading');
	        this.config = this.loadConfigFromUser(userConfig, defaults);
	        this.context = new SvgStrategy_1.SvgContext(strategy, this.config);
	        this.data = data;
	    }
	    Chart.prototype.draw = function (data) {
	        if (data === void 0) { data = this.data; }
	        this.context.draw(functions_1.copy(data));
	        this.data = data;
	    };
	    ...
	    Chart.prototype.loadConfigFromUser = function (userData, defaults) {
	        ...
	        width = screen_1.calculateWidth(width, config.get('selector')) - config.get('marginLeft') - config.get('marginRight');
...
/***/ function(module, exports) {
	...
	exports.isValuesInObjectKeys = isValuesInObjectKeys;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function calculateWidth(widthConfig, selector) {
	    if (widthConfig === 'auto') {
	        return d3_1.select(selector)
	            .node()
	            .getBoundingClientRect()
	            .width;
	    }
	    else if (functions_1.isNumeric(widthConfig)) {
	        return widthConfig;
	    }
	    else if (functions_1.isPercentage(widthConfig)) {
	        var containerWidth = void 0, percentage = void 0;
	        containerWidth = d3_1.select(selector)
	            .node()
	            .getBoundingClientRect()
	            .width;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var XYAxes_1 = __webpack_require__(9);
	var Lineset_1 = __webpack_require__(15);
	var Pointset_1 = __webpack_require__(16);
	var Areaset_1 = __webpack_require__(17);
	var Legend_1 = __webpack_require__(18);
	var SvgChart_1 = __webpack_require__(19);
	var dataSorting_1 = __webpack_require__(21);
	var dataTransformation_1 = __webpack_require__(14);
	var SvgStrategyLinechart = (function (_super) {
	    __extends(SvgStrategyLinechart, _super);
	    function SvgStrategyLinechart() {
	        var _this = _super.call(this) || this;
	        _this.axes = new XYAxes_1.default();
	        _this.lines = new Lineset_1.default(_this.axes.x, _this.axes.y);
	        return _this;
	    }
	    SvgStrategyLinechart.prototype.draw = function (data) {
	        ...
	        dataTransformation_1.convertByXYFormat(data, xAxisFormat, xAxisType, yAxisFormat, yAxisType, propertyX, propertyY);
	        dataSorting_1.sortByField(data, propertyX);
	    ...
	    SvgStrategyLinechart.prototype.initialize = function () {
	        ...
	        if (areaOpacity > 0) {
	            this.area = new Areaset_1.default(this.axes.x, this.axes.y);
	            this.container.add(this.area);
	        }
	        if (markerSize > 0) {
	            this.markers = new Pointset_1.default(this.axes.x, this.axes.y);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var XAxis_1 = __webpack_require__(10);
	var YAxis_1 = __webpack_require__(12);
	var Component_1 = __webpack_require__(11);
	var XYAxis = (function (_super) {
	    __extends(XYAxis, _super);
	    function XYAxis() {
	        var _this = _super.call(this) || this;
	        _this._x = new XAxis_1.default();
	        _this._y = new YAxis_1.default();
	        return _this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var XAxis = (function (_super) {
	    ...
	    XAxis.prototype.update = function (data) {
	        ...
	        if (xAxisType === 'linear') {
	            var min = d3_1.min(data, function (d) { return d[propertyX]; }), max = d3_1.max(data, function (d) { return d[propertyX]; });
	            this.updateDomainByMinMax(min, max);
	        }
	        else if (xAxisType === 'time') {
	            var min = d3_1.min(data, function (d) { return (d[propertyX] || d[_this.config.get('propertyStart')]); }), max = d3_1.max(data, function (d) { return (d[propertyX] || d[_this.config.get('propertyEnd')]); });
	            this.updateDomainByMinMax(min, max);
	        }
	        else {
	            var keys = d3_1.map(data, function (d) { return d[propertyX]; }).keys();
	    ...
	    XAxis.prototype.updateDomainByMinMax = function (min, max) {
	    ...
	    XAxis.prototype.initializeXAxis = function (width, height, xAxisFormat, xAxisType, xAxisGrid) {
	        switch (xAxisType) {
	            case 'time':
	                this._xAxis = d3_1.axisBottom(d3_1.scaleTime().range([0, width]));
	                break;
	            case 'linear':
	                this._xAxis = d3_1.axisBottom(d3_1.scaleLinear().range([0, width]))
	                    .tickFormat(d3_1.format(xAxisFormat));
	                break;
	            case 'categorical':
	                this._xAxis = d3_1.axisBottom(d3_1.scaleBand().rangeRound([0, width])
...
/***/ function(module, exports, __webpack_require__) {
	...
	var YAxis = (function (_super) {
	    ...
	    YAxis.prototype.update = function (data) {
	        ...
	        if (yAxisType === 'linear') {
	            if (layoutStacked) {
	                var keys = d3_1.map(data, function (d) { return d[propertyKey]; }).keys();
	                var stack_1 = this.config.get('stack');
	                var stackedData = stack_1.keys(keys)(dataTransformation_1.simple2stacked(data, propertyX, propertyY, propertyKey));
	                var min = d3_1.min(stackedData, function (serie) { return d3_1.min(serie, function (d) { return d[0]; }); });
	                var max = d3_1.max(stackedData, function (serie) { return d3_1.max(serie, function (d) { return d[1]; }); });
	                this.updateDomainByMinMax(min, max);
	            }
	            else {
	                var min = d3_1.min(data, function (d) { return d[propertyY]; }), max = d3_1.max(data, function (d) { return d[propertyY]; });
	                this.updateDomainByMinMax(min, max);
	            }
	        }
	        else if (yAxisType === 'categorical') {
	            var keys = d3_1.map(data, function (d) { return d[propertyKey]; }).keys().sort();
	    ...
	    YAxis.prototype.updateDomainByMinMax = function (min, max) {
	        this._yAxis.scale().domain([min, max]);
	    };
	    YAxis.prototype.transition = function (time) {
	        if (time === void 0) { time = 200; }
	        this.selection.transition().duration(Globals_1.default.COMPONENT_TRANSITION_TIME).call(this._yAxis);
	        ...
	        switch (yAxisType) {
	            case 'linear':
	                this._yAxis = (this.orient === 'left')
	                    ? d3_1.axisLeft(d3_1.scaleLinear().range([height, 0])).tickFormat(d3_1.format(yAxisFormat))
	                    : d3_1.axisRight(d3_1.scaleLinear().range([height, 0])).tickFormat(d3_1.format(yAxisFormat));
	                break;
	            case 'categorical':
	                this._yAxis = (this.orient === 'left')
	                    ? d3_1.axisLeft(d3_1.scaleBand().rangeRound([height, 0]).padding(0.1).align(0.5))
	                    : d3_1.axisRight(d3_1.scaleBand().rangeRound([height, 0]).padding(0.1).align(0.5));
	                break;
	            default:
...
/***/ function(module, exports, __webpack_require__) {
	...
	function simple2stacked(data, xProperty, yProperty, keyProperty) {
	    return d3_1.nest().key(function (d) { return d[xProperty]; }).rollup(function (values) {
	        var r = {};
	...
	exports.simple2stacked = simple2stacked;
	function simple2nested(data, key) {
	    if (key === void 0) { key = 'key'; }
	    return d3_1.nest().key(function (d) { return d[key]; }).entries(data);
	}
	exports.simple2nested = simple2nested;
	function nested2simple(data) {
	    var array = Array();
	    for (var i = 0; i < data.length; i++) {
	        for (var j = 0; j < data[i].values.length; j++) {
	            var key = data[i].key;
	            var x = data[i].values[j].x;
	            var y = data[i].values[j].y;
	            array.push({ key: key, x: x, y: y });
	        }
	    }
	    return array;
	}
	exports.nested2simple = nested2simple;
	...
	exports.simple2Linked = simple2Linked;
	function convertPropretiesToTimeFormat(data, properties, format) {
	    data.forEach(function (d) {
	        properties.map(function (p) {
	            d[p] = d3_1.timeParse(format)(d[p]);
	        });
	    });
	}
	exports.convertPropretiesToTimeFormat = convertPropretiesToTimeFormat;
	function convertByXYFormat(data, xAxisFormat, xAxisType, yAxisFormat, yAxisType, propertyX, propertyY) {
	    data.forEach(function (d) {
	        switch (xAxisType) {
	            case 'time':
	                d[propertyX] = d3_1.timeParse(xAxisFormat)(d[propertyX]);
	                break;
	            case 'linear':
	        ...
	        switch (yAxisType) {
	            case 'time':
	                d[propertyY] = d3_1.timeParse(yAxisFormat)(d[propertyY]);
	                break;
	            case 'linear':
	...
	exports.convertByXYFormat = convertByXYFormat;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Lineset = (function (_super) {
	    ...
	    Lineset.prototype.update = function (data) {
	        var _this = this;
	        var propertyKey = this.config.get('propertyKey');
	        var dataSeries = d3_1.nest().key(function (d) { return d[propertyKey]; }).entries(data);
	        ...
	        var lines = series.data(dataSeries, function (d) { return d[propertyKey]; })
	            ...
	            .attr(Globals_1.default.COMPONENT_DATA_KEY_ATTRIBUTE, function (d) { return d[propertyKey]; })
	        ...
	        this.svg.selectAll('.line')
	            ...
	            .attr('d', function (d) { return _this.lineGenerator(d.values); })
	            .transition()
	            .duration(Globals_1.default.COMPONENT_TRANSITION_TIME)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Pointset = (function (_super) {
	    ...
	    Pointset.prototype.update = function (data) {
	        ...
	        var shape = d3_1.symbol().size(markerSize);
	        series = this.svg.selectAll('g.points');
	        switch (markerShape) {
	            case 'dot':
	                shape.type(d3_1.symbolCircle);
	                break;
	            case 'ring':
	                shape.type(d3_1.symbolCircle);
	                break;
	            case 'cross':
	                shape.type(d3_1.symbolCross);
	                break;
	            case 'diamond':
	                shape.type(d3_1.symbolDiamond);
	                break;
	            case 'square':
	                shape.type(d3_1.symbolSquare);
	                break;
	            case 'star':
	                shape.type(d3_1.symbolStar);
	                break;
	            case 'triangle':
	                shape.type(d3_1.symbolTriangle);
	                break;
	            case 'wye':
	                shape.type(d3_1.symbolWye);
	                break;
	            case 'circle':
	                shape.type(d3_1.symbolCircle);
	                break;
	...
	var Legend = (function (_super) {
	    ...
	    Legend.prototype.update = function (data) {
	        ...
	        entries = legend.selectAll('.legend-entry')
	            ...
	            .attr(Globals_1.default.LEGEND_DATA_KEY_ATTRIBUTE, function (d) { return d.key; });
	        entries.append('rect')
	            .attr('x', width + 10)
	    ...
	    Legend.prototype.toggle = function (d) {
	        var key = d.key, element = this.svg.selectAll('*[' + Globals_1.default.COMPONENT_DATA_KEY_ATTRIBUTE + '="' + key + '"]'), colorScale = this.config.get('colorScale');
	        if (!element.empty()) {
	            var opacity_1 = parseInt(element.style('opacity'));
	            opacity_1 = (opacity_1 == 1) ? Globals_1.default.COMPONENT_HIDE_OPACITY : 1;
	            var legendEntry = this.svg.select('.legend-entry[' + Globals_1.default.LEGEND_DATA_KEY_ATTRIBUTE + '="' + key + '"]');
	            legendEntry.selectAll('rect')
	                .transition()
	                .duration(Globals_1.default.COMPONENT_HIDE_SHOW_TRANSITION_TIME)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SvgChart = (function () {
	    ...
	    SvgChart.prototype.initialize = function () {
	        this.container = new Container_1.default(this.config);
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Container = (function () {
	    ...
	    Container.prototype.zoom = function (z) {
	        this.svg.call(d3_1.zoom().scaleExtent([1 / 2, 4]).on("zoom", z));
	    };
	    Container.prototype.addLoadingIcon = function () {
	        var icon = Globals_1.default.LOADING_ICON;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Interpolation_1 = __webpack_require__(24);
	exports.defaults = {
	    selector: '#chart',
	    colorScale: Colors.category7(),
	    curve: Interpolation_1.default.CURVE_MONOTONE_X,
	    areaOpacity: 0,
	    xAxisType: 'linear',
	    xAxisFormat: '',
	    xAxisLabel: null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	Interpolation.CURVE_LINEAR = d3_1.curveLinear;
	Interpolation.CURVE_LINEAR_CLOSED = d3_1.curveLinearClosed;
	Interpolation.CURVE_MONOTONE_X = d3_1.curveMonotoneX;
	Interpolation.CURVE_MONOTONE_Y = d3_1.curveMonotoneY;
	Interpolation.CURVE_NATURAL = d3_1.curveNatural;
	Interpolation.CURVE_STEP = d3_1.curveStep;
	Interpolation.CURVE_STEP_AFTER = d3_1.curveStepAfter;
	Interpolation.CURVE_STEP_BEFORE = d3_1.curveStepBefore;
	;
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Chart_1 = __webpack_require__(2);
	var SvgStrategyBarchart_1 = __webpack_require__(26);
	var barchart_1 = __webpack_require__(28);
	var functions_1 = __webpack_require__(5);
	var Barchart = (function (_super) {
	    __extends(Barchart, _super);
	    function Barchart(data, userConfig) {
	        if (userConfig === void 0) { userConfig = {}; }
	        return _super.call(this, new SvgStrategyBarchart_1.default(), data, userConfig, barchart_1.defaults) || this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var XYAxes_1 = __webpack_require__(9);
	var Barset_1 = __webpack_require__(27);
	var Legend_1 = __webpack_require__(18);
	var SvgChart_1 = __webpack_require__(19);
	var dataSorting_1 = __webpack_require__(21);
	var dataTransformation_1 = __webpack_require__(14);
	var SvgStrategyBarchart = (function (_super) {
	    ...
	    function SvgStrategyBarchart() {
	        var _this = _super.call(this) || this;
	        _this.axes = new XYAxes_1.default();
	        _this.bars = new Barset_1.default(_this.axes.x, _this.axes.y);
	        return _this;
	    }
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = SvgStrategyBarchart;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Barset = (function (_super) {
	    ...
	    Barset.prototype.updateStacked = function (data) {
	        ...
	        var propertyY = this.config.get('propertyY');
	        var keys = d3_1.map(data, function (d) { return d[propertyKey]; }).keys();
	        var stack = this.config.get('stack');
	        data = stack.keys(keys)(dataTransformation_1.simple2stacked(data, propertyX, propertyY, propertyKey));
	    ...
	    Barset.prototype.updateGrouped = function (data) {
	        ...
	        var propertyX = this.config.get('propertyX');
	        var propertyY = this.config.get('propertyY');
	        var keys = d3_1.map(data, function (d) { return d[propertyKey]; }).keys(), colorScale = this.config.get('colorScale'), layer = null, x = this.x.xAxis.scale(), y = this.y.yAxis.scale(), xGroup = d3_1.scaleBand().domain(keys).range([0, x.bandwidth()]), height = this.config.get('height');
	        var dataNested = dataTransformation_1.simple2nested(data, 'key');
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.defaults = {
	    ...
	    propertyY: 'y',
	    propertyKey: 'key',
	    stack: d3_1.stack().value(function (d, k) { return d.value[k]; }),
	    onDown: function (d) {
	    },
	    onHover: function (d) {
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Chart_1 = __webpack_require__(2);
	var SvgStrategyGauge_1 = __webpack_require__(30);
	var gauge_1 = __webpack_require__(34);
	var Gauge = (function (_super) {
	    __extends(Gauge, _super);
	    function Gauge(data, userConfig) {
	        if (userConfig === void 0) { userConfig = {}; }
	        return _super.call(this, new SvgStrategyGauge_1.default(), data, userConfig, gauge_1.defaults) || this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SvgChart_1 = __webpack_require__(19);
	var Dial_1 = __webpack_require__(31);
	var DialNeedle_1 = __webpack_require__(32);
	var TextIndicator_1 = __webpack_require__(33);
	var SvgStrategyGauge = (function (_super) {
	    __extends(SvgStrategyGauge, _super);
	    function SvgStrategyGauge() {
	        var _this = _super.call(this) || this;
	        _this.dial = new Dial_1.default();
	        _this.dialNeedle = new DialNeedle_1.default();
	        _this.textIndicator = new TextIndicator_1.default();
	        return _this;
	    }
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = SvgStrategyGauge;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DialNeedle = (function (_super) {
	    ...
	    DialNeedle.prototype.render = function () {
	        var labels = null, invertColorScale = this.config.get('invertColorScale'), colorScale = this.config.get('colorScale'), width = this.config.get('width'), height = this.config.get('height'), ringWidth = this.config.get('ringWidth'), ringMargin = this.config.get('ringMargin'), ticks = this.config.get('ticks'), minAngle = this.config.get('minAngle'), maxAngle = this.config.get('maxAngle'), minLevel = this.config.get('minLevel'), maxLevel = this.config.get('maxLevel'), labelInset = this.config.get('labelInset'), needleNutRadius = this.config.get('needleNutRadius'), needleLenghtRatio = this.config.get('needleLenghtRatio'), scale = d3_1.scaleLinear()
	            .domain([minLevel, maxLevel])
	            .range([0, 1]), scaleMarkers = scale.ticks(ticks), range = maxAngle - minAngle, r = ((width > height) ?
	            height : width) / 2, needleLen = needleLenghtRatio * (r), translation = (function () { return 'translate(' + r + ',' + r + ')'; }), tickData = d3_1.range(ticks).map(function () { return 1 / ticks; }), arc = d3_1.arc()
	            .innerRadius(r - ringWidth - ringMargin)
	            .outerRadius(r - ringMargin)
	            .startAngle(function (d, i) { return functions_1.deg2rad(minAngle + ((d * i) * range)); })
	            .endAngle(function (d, i) { return functions_1.deg2rad(minAngle + ((d * (i + 1)) * range)); }), angleScale = d3_1.scaleLinear()
	            .domain([minLevel, maxLevel])
	    ...
	    DialNeedle.prototype.update = function (data) {
	        var datum = data[data.length - 1], width = this.config.get('width'), height = this.config.get('height'), needleNutRadius = this.config.get('needleNutRadius'), needleLenghtRatio = this.config.get('needleLenghtRatio'), propertyValue = this.config.get('propertyValue'), minAngle = this.config.get('minAngle'), maxAngle = this.config.get('maxAngle'), minLevel = this.config.get('minLevel'), maxLevel = this.config.get('maxLevel'), r = ((width > height) ?
	            height : width) / 2, needleLen = needleLenghtRatio * (r), angleScale = d3_1.scaleLinear()
	            .domain([minLevel, maxLevel])
	            .range([90 + minAngle, 90 + maxAngle]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Chart_1 = __webpack_require__(2);
	var SvgStrategyScatterplot_1 = __webpack_require__(36);
	var scatterplot_1 = __webpack_require__(38);
	var functions_1 = __webpack_require__(5);
	var Scatterplot = (function (_super) {
	    __extends(Scatterplot, _super);
	    function Scatterplot(data, userConfig) {
	        if (userConfig === void 0) { userConfig = {}; }
	        return _super.call(this, new SvgStrategyScatterplot_1.default(), data, userConfig, scatterplot_1.defaults) || this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dataSorting_1 = __webpack_require__(21);
	var dataTransformation_1 = __webpack_require__(14);
	var CanvasPointset_1 = __webpack_require__(37);
	var SvgStrategyScatterplot = (function (_super) {
	    __extends(SvgStrategyScatterplot, _super);
	    function SvgStrategyScatterplot() {
	        var _this = _super.call(this) || this;
	        _this.axes = new XYAxes_1.default();
	        _this.markers = new Pointset_1.default(_this.axes.x, _this.axes.y);
	        _this.canvasMarkers = new CanvasPointset_1.default(_this.axes.x, _this.axes.y);
	        return _this;
	    }
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = SvgStrategyScatterplot;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CanvasPointset = (function (_super) {
	    ...
	    CanvasPointset.prototype.render = function () {
	        this.canvas = d3_1.select(this.config.get('selector')).append('canvas')
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = CanvasPointset;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Chart_1 = __webpack_require__(2);
	var SvgStrategyStreamgraph_1 = __webpack_require__(40);
	var streamgraph_1 = __webpack_require__(42);
	var functions_1 = __webpack_require__(5);
	var Streamgraph = (function (_super) {
	    __extends(Streamgraph, _super);
	    function Streamgraph(data, userConfig) {
	        if (userConfig === void 0) { userConfig = {}; }
	        return _super.call(this, new SvgStrategyStreamgraph_1.default(), data, userConfig, streamgraph_1.defaults) || this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var XYAxes_1 = __webpack_require__(9);
	var Legend_1 = __webpack_require__(18);
	var Streamset_1 = __webpack_require__(41);
	var SvgChart_1 = __webpack_require__(19);
	var dataSorting_1 = __webpack_require__(21);
	var dataTransformation_1 = __webpack_require__(14);
	var SvgStrategyStreamgraph = (function (_super) {
	    ...
	    function SvgStrategyStreamgraph() {
	        var _this = _super.call(this) || this;
	        _this.axes = new XYAxes_1.default();
	        _this.streams = new Streamset_1.default(_this.axes);
	        return _this;
	    }
	    SvgStrategyStreamgraph.prototype.draw = function (data) {
	        var xAxisFormat = this.config.get('xAxisFormat'), xAxisType = this.config.get('xAxisType'), yAxisFormat = this.config.get('yAxisFormat'), yAxisType = this.config.get('yAxisType'), propertyX = this.config.get('propertyX'), propertyY = this.config.get('propertyY');
	        dataTransformation_1.convertPropretiesToTimeFormat(data, [propertyX], xAxisFormat);
	        dataSorting_1.sortByField(data, propertyX);
	        this.container.updateComponents(data);
	    };
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = SvgStrategyStreamgraph;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Streamset = (function (_super) {
	    ...
	    function Streamset(xyAxes) {
	        var _this = _super.call(this) || this;
	        _this.xyAxes = xyAxes;
	        _this.areaGenerator = d3_1.area()
	            .curve(d3_1.curveCardinal)
	    ...
	    Streamset.prototype.update = function (data) {
	        ...
	        var propertyY = this.config.get('propertyY');
	        this.clean();
	        var colorScale = this.config.get('colorScale'), onDown = this.config.get('onDown'), onUp = this.config.get('onUp'), onLeave = this.config.get('onLeave'), onHover = this.config.get('onHover'), onClick = this.config.get('onClick'), keys = d3_1.map(data, function (d) { return d[propertyKey]; }).keys(), data4stack = dataTransformation_1.simple2stacked(data, propertyX, propertyY, propertyKey), stack = this.config.get('stack'), dataSeries = stack(data4stack), series = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.defaults = {
	    ...
	    propertyY: 'y',
	    propertyKey: 'key',
	    stack: d3_1.stack().value(function (d, k) { return d.value[k]; }).order(d3_1.stackOrderInsideOut).offset(d3_1.stackOffsetWiggle),
	    stacked: true,
	    onDown: function (d) {
	    },
	    onHover: function (d) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Chart_1 = __webpack_require__(2);
	var SvgStrategyStreamgraph_1 = __webpack_require__(40);
	var stackedArea_1 = __webpack_require__(44);
	var functions_1 = __webpack_require__(5);
	var StackedArea = (function (_super) {
	    __extends(StackedArea, _super);
	    function StackedArea(data, userConfig) {
	        if (userConfig === void 0) { userConfig = {}; }
	        return _super.call(this, new SvgStrategyStreamgraph_1.default(), data, userConfig, stackedArea_1.defaults) || this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.defaults = {
	    ...
	    propertyKey: 'key',
	    stacked: true,
	    stack: d3_1.stack().value(function (d, k) { return d.value[k]; }).order(d3_1.stackOrderInsideOut).offset(d3_1.stackOffsetNone),
	    onDown: function (d) {
	    },
	    onHover: function (d) {
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Chart_1 = __webpack_require__(2);
	var SvgStrategySwimlane_1 = __webpack_require__(46);
	var swimlane_1 = __webpack_require__(48);
	var functions_1 = __webpack_require__(5);
	var Swimlane = (function (_super) {
	    __extends(Swimlane, _super);
	    function Swimlane(data, userConfig) {
	        if (userConfig === void 0) { userConfig = {}; }
	        return _super.call(this, new SvgStrategySwimlane_1.default(), data, userConfig, swimlane_1.defaults) || this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var XYAxes_1 = __webpack_require__(9);
	var Legend_1 = __webpack_require__(18);
	var Timeboxset_1 = __webpack_require__(47);
	var SvgChart_1 = __webpack_require__(19);
	var dataSorting_1 = __webpack_require__(21);
	var dataTransformation_1 = __webpack_require__(14);
	var SvgStrategySwimlane = (function (_super) {
	    ...
	    function SvgStrategySwimlane() {
	        var _this = _super.call(this) || this;
	        _this.axes = new XYAxes_1.default();
	        _this.boxes = new Timeboxset_1.default(_this.axes);
	        return _this;
	    }
	    SvgStrategySwimlane.prototype.draw = function (data) {
	        ...
	        dataTransformation_1.convertPropretiesToTimeFormat(data, [propertyStart, propertyEnd], xAxisFormat);
	        dataSorting_1.sortByField(data, propertyStart);
	        this.container.updateComponents(data);
	    };
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = SvgStrategySwimlane;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timeboxset = (function (_super) {
	    ...
	    Timeboxset.prototype.update = function (data) {
	        ...
	        var colorScale = this.config.get('colorScale'), height = this.config.get('height'), onDown = this.config.get('onDown'), onUp = this.config.get('onUp'), onLeave = this.config.get('onLeave'), onHover = this.config.get('onHover'), onClick = this.config.get('onClick'), keys = d3_1.map(data, function (d) { return d[propertyKey]; }).keys(), layer = this.svg.selectAll('.serie').data(data), layerEnter = null, layerMerge = null, box = null, boxEnter = null, boxMerge = null, extLanes = null, yLanes = null, yLanesBand = d3_1.scaleBand().range([0, keys.length + 1]).domain(keys), x = this.xyAxes.x.xAxis.scale(), y = this.xyAxes.y.yAxis.scale();
	        data = dataTransformation_1.simple2nested(data);
	        extLanes = d3_1.extent(data, function (d, i) { return i; });
	        yLanes = d3_1.scaleLinear().domain([extLanes[0], extLanes[1] + 1]).range([0, height]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Chart_1 = __webpack_require__(2);
	var SvgStrategySunburst_1 = __webpack_require__(50);
	var sunburst_1 = __webpack_require__(55);
	var functions_1 = __webpack_require__(5);
	var Sunburst = (function (_super) {
	    __extends(Sunburst, _super);
	    function Sunburst(data, userConfig) {
	        if (userConfig === void 0) { userConfig = {}; }
	        return _super.call(this, new SvgStrategySunburst_1.default(), data, userConfig, sunburst_1.defaults) || this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SvgChart_1 = __webpack_require__(19);
	var RadialAxes_1 = __webpack_require__(51);
	var SunburstDisk_1 = __webpack_require__(54);
	var TextIndicator_1 = __webpack_require__(33);
	var SvgStrategySunburst = (function (_super) {
	    __extends(SvgStrategySunburst, _super);
	    function SvgStrategySunburst() {
	        var _this = _super.call(this) || this;
	        _this.axes = new RadialAxes_1.default();
	        _this.disk = new SunburstDisk_1.default(_this.axes.x, _this.axes.y);
	        _this.textIndicator = new TextIndicator_1.default();
	        return _this;
	    }
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = SvgStrategySunburst;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Component_1 = __webpack_require__(11);
	var XRadialAxis_1 = __webpack_require__(52);
	var YRadialAxis_1 = __webpack_require__(53);
	var RadialAxes = (function (_super) {
	    __extends(RadialAxes, _super);
	    function RadialAxes() {
	        var _this = _super.call(this) || this;
	        _this._x = new XRadialAxis_1.default();
	        _this._y = new YRadialAxis_1.default();
	        return _this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var XRadialAxis = (function (_super) {
	    ...
	    XRadialAxis.prototype.render = function () {
	        this._xRadialAxis = d3_1.scaleLinear().range([0, 2 * Math.PI]);
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var YRadialAxis = (function (_super) {
	    ...
	    YRadialAxis.prototype.render = function () {
	        ...
	        this._yRadialAxis = d3_1.scaleSqrt().range([0, radius]);
	    };
	    ;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Chart_1 = __webpack_require__(2);
	var SvgStrategyNetwork_1 = __webpack_require__(57);
	var network_1 = __webpack_require__(60);
	var functions_1 = __webpack_require__(5);
	var Network = (function (_super) {
	    __extends(Network, _super);
	    function Network(data, userConfig) {
	        if (userConfig === void 0) { userConfig = {}; }
	        return _super.call(this, new SvgStrategyNetwork_1.default(), data, userConfig, network_1.defaults) || this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LinkedNodeset_1 = __webpack_require__(58);
	var Legend_1 = __webpack_require__(18);
	var ZoomComponent_1 = __webpack_require__(59);
	var SvgChart_1 = __webpack_require__(19);
	var SvgStrategyNetwork = (function (_super) {
	    ...
	    SvgStrategyNetwork.prototype.initialize = function () {
	        _super.prototype.initialize.call(this);
	        var legend = this.config.get('legend');
	        var zoom = this.config.get('zoom');
	        this.linkedNodes = new LinkedNodeset_1.default();
	        ...
	        if (zoom) {
	            this.zoom = new ZoomComponent_1.default(this.linkedNodes);
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = SvgStrategyNetwork;
	...
	var LinkedNodeset = (function (_super) {
	    ...
	    LinkedNodeset.prototype.render = function () {
	        ...
	        this.simulation = d3_1.forceSimulation()
	            .force("link", d3_1.forceLink().id(function (d) { return d.id; }).distance(50))
	            .force("charge", d3_1.forceManyBody())
	            .force("center", d3_1.forceCenter(width / 2, height / 2));
	        this.dragstarted = function (d) {
	            if (!d3_1.event.active)
	    ...
	    LinkedNodeset.prototype.update = function (data) {
	        ...
	        link = this.svg.append('g')
	            ...
	            .enter()
	            .append("line")
	            .attr(Globals_1.default.COMPONENT_DATA_KEY_ATTRIBUTE, function (d) { console.log(d); return d.key; })
	        ...
	        node = this.svg.select('g.serie').append("g")
	            ...
	            .enter()
	            .append("circle")
	            .attr(Globals_1.default.COMPONENT_DATA_KEY_ATTRIBUTE, function (d) { return d.key; })
	    ...
	    LinkedNodeset.prototype.zoom = function (event) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ZoomComponent = (function (_super) {
	    ...
	    function ZoomComponent(zoomerComponent) {
	        ...
	        _this.zoom = d3_1.zoom().scaleExtent([1 / 2, 4]);
	        return _this;
	    }
	    ZoomComponent.prototype.render = function () {
	        var _this = this;
	        var selector = this.config.get('selector');
	        d3_1.select(selector).call(this.zoom);
	        this.zoom.on('zoom', function () {
	            _this.zoomerComponent.zoom(d3_1.event);
	        });
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Chart_1 = __webpack_require__(2);
	var SvgStrategyPieChart_1 = __webpack_require__(62);
	var piechart_1 = __webpack_require__(64);
	var functions_1 = __webpack_require__(5);
	var PieChart = (function (_super) {
	    __extends(PieChart, _super);
	    function PieChart(data, userConfig) {
	        if (userConfig === void 0) { userConfig = {}; }
	        return _super.call(this, new SvgStrategyPieChart_1.default, data, userConfig, piechart_1.defaults) || this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = SvgStrategyPieChart;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SectorSet = (function (_super) {
	    ...
	    SectorSet.prototype.update = function (data) {
	        ...
	        var colorScale = this.config.get('colorScale');
	        var myPie = d3_1.pie().value(function (d) { return d[propertyX]; })(data);
	        var myArc = d3_1.arc().innerRadius(0).outerRadius(radius);
	        var arcs = this.svg.selectAll("g.slice").data(myPie);
	        var newBlock = arcs.enter();
	        newBlock
	            .append("g")
	            .attr(Globals_1.default.COMPONENT_DATA_KEY_ATTRIBUTE, function (d) { return d.data[propertyKey]; })
	            .append("path")
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Datasource_1 = __webpack_require__(66);
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = WebsocketDatasource;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HTTPDatasource = (function (_super) {
	    ...
	    HTTPDatasource.prototype._startRequest = function (url) {
	        var _this = this;
	        d3_1.request(url).get(function (e, response) { return _this._handleResponse(response); });
	    };
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = HTTPDatasource;
