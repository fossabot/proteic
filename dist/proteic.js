...
var Legend = (function (_super) {
    ...
    Legend.prototype.toggle = function (d) {
        var key = d.key, element = this.svg.selectAll('*[' + Globals.COMPONENT_DATA_KEY_ATTRIBUTE + '="' + key + '"]');
        if (!element.empty()) {
