...
var SvgLinechartStrategy = function SvgLinechartStrategy(chartContext) {
...
SvgLinechartStrategy.prototype.changeConfigProperty = function changeConfigProperty (p, v) {
  this.config[p] = v;
  if (p === 'width' || p === 'height') {
...
SvgLinechartStrategy.prototype.rescale = function rescale (width, height) {
...
var SvgBarchartStrategy = function SvgBarchartStrategy(chartContext) {
  this._loadConfigOnContext(chartContext.config);
  var config = this.config;
...
SvgBarchartStrategy.prototype.changeConfigProperty = function changeConfigProperty (p, v) {
  this.config[p] = v;
  if (p === 'width' || p === 'height') {
    this.config.needAxisRescaling = true;
  }
...
SvgBarchartStrategy.prototype.rescale = function rescale (width, height) {
    if ( width === void 0 ) width = this.config.width;
    if ( height === void 0 ) height = this.config.height;
...
var SvgStreamgraphStrategy = function SvgStreamgraphStrategy(chartContext) {
      this._loadConfigOnContext(chartContext.config);
      var config = this.config;
...
SvgStreamgraphStrategy.prototype.changeConfigProperty = function changeConfigProperty (p, v) {
  this.config[p] = v;
  if (p === 'width' || p === 'height') {
    this.config.needAxisRescaling = true;
  }
...
SvgStreamgraphStrategy.prototype.rescale = function rescale (width, height) {
    if ( width === void 0 ) width = this.config.width;
    if ( height === void 0 ) height = this.config.height;
...
var SvgStackedAreaStrategy = function SvgStackedAreaStrategy(chartContext) {
    this._loadConfigOnContext(chartContext.config);
    var config = this.config;
...
SvgStackedAreaStrategy.prototype.rescale = function rescale (width, height) {
        if ( width === void 0 ) width = this.config.width;
        if ( height === void 0 ) height = this.config.height;
...
SvgStackedAreaStrategy.prototype.changeConfigProperty = function changeConfigProperty (p, v) {
    this.config[p] = v;
    if (p === 'width' || p === 'height') {
        this.config.needAxisRescaling = true;
    }
...
var SvgSwimlaneStrategy = function SvgSwimlaneStrategy(chartContext) {
  this._loadConfigOnContext(chartContext.config);
  var config = this.config;
  this.svgContainer = new SvgContainer(config);
...
SvgSwimlaneStrategy.prototype.changeConfigProperty = function changeConfigProperty (p, v) {
  this.config[p] = v;
  if (p === 'width' || p === 'height') {
    this.config.needAxisRescaling = true;
  }
...
SvgSwimlaneStrategy.prototype.rescale = function rescale (width, height) {
    if ( width === void 0 ) width = this.config.width;
    if ( height === void 0 ) height = this.config.height;
...
>>>>>>> a48b364270dc7984272cf10deeccaf6ff698ad59
  this.config.x = {};
...
var SvgGaugeStrategy = function SvgGaugeStrategy(chartContext) {
  this._loadConfigOnContext(chartContext.config);
...
var SvgSunburstStrategy = function SvgSunburstStrategy(chartContext) {
  this._loadConfigOnContext(chartContext.config);
  var config = this.config;
  var radius = (Math.min(config.width, config.height) / 2) - 10;
