...
SvgAxis.prototype._loadConfigOnContext = function _loadConfigOnContext (config, defaults) {
    this.config = {};
    //Selector
...
var SvgLinechartStrategy = (function (SvgAxis$$1) {
  ...
  SvgLinechartStrategy.prototype._loadConfigOnContext = function _loadConfigOnContext (config) {
    SvgAxis$$1.prototype._loadConfigOnContext.call(this, config, defaults);
    //Markers
...
var SvgBarchartStrategy = (function (SvgAxis$$1) {
  ...
  SvgBarchartStrategy.prototype._loadConfigOnContext = function _loadConfigOnContext (config) {
    SvgAxis$$1.prototype._loadConfigOnContext.call(this, config, defaults$1);
    //Stacked
...
var SvgStreamgraphStrategy = (function (SvgAxis$$1) {
  ...
  SvgStreamgraphStrategy.prototype.constructor = SvgStreamgraphStrategy;
    ...
    SvgStreamgraphStrategy.prototype._loadConfigOnContext = function _loadConfigOnContext (config) {
        SvgAxis$$1.prototype._loadConfigOnContext.call(this, config,defaults$2);
        return this;
    };
...
var SvgStackedAreaStrategy = (function (SvgAxis$$1) {
    ...
    SvgStackedAreaStrategy.prototype._loadConfigOnContext = function _loadConfigOnContext (config) {
        SvgAxis$$1.prototype._loadConfigOnContext.call(this, config,defaults$3);
    };
...
var SvgSwimlaneStrategy = (function (SvgAxis$$1) {
  ...
  SvgSwimlaneStrategy.prototype._loadConfigOnContext = function _loadConfigOnContext (config) {
    SvgAxis$$1.prototype._loadConfigOnContext.call(this, config, defaults$4);  
    return this;
  };
...
SvgNetworkgraphStrategy.prototype._loadConfigOnContext = function _loadConfigOnContext (config) {
  this.config = {};
  this.config.margin = config.margin || defaults$6.margin;
  ...
  this.config.width = config.width ? calculateWidth(config.width, this.config.selector) - this.config.margin.left - this.config.margin.right
    : calculateWidth(defaults$6.width, this.config.selector) - this.config.margin.left - this.config.margin.right;
