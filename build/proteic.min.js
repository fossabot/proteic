...
var WebsocketDatasource = (function (Datasource$$1) {
    ...
    WebsocketDatasource.prototype.start = function start () {
        ...
        this.ws.onerror = function (e) {
            this$1.dispatcher.call('onerror', this$1, e);
        };
...
var SvgStrategy$1 = function SvgStrategy$1(context) {
    this._loadConfigOnContext(context.config);
    this.svgContainer = new SvgContainer(this.config);
};

SvgStrategy$1.prototype.changeConfigProperty = function changeConfigProperty (p, v) {
    this.config[p] = v;
    if (p === 'width' || p === 'height') {
...
SvgStrategy$1.prototype.rescale = function rescale (width, height) {
...
var SvgLinechartStrategy = (function (SvgStrategy$$1) {
  function SvgLinechartStrategy(context) {
    SvgStrategy$$1.call(this, context);
  ...
  if ( SvgStrategy$$1 ) SvgLinechartStrategy.__proto__ = SvgStrategy$$1;
  SvgLinechartStrategy.prototype = Object.create( SvgStrategy$$1 && SvgStrategy$$1.prototype );
...
var SvgBarchartStrategy = (function (SvgStrategy$$1) {
  ...
  if ( SvgStrategy$$1 ) SvgBarchartStrategy.__proto__ = SvgStrategy$$1;
  SvgBarchartStrategy.prototype = Object.create( SvgStrategy$$1 && SvgStrategy$$1.prototype );
  ...
  SvgBarchartStrategy.prototype._loadConfigOnContext = function _loadConfigOnContext (config) {
    ...
    this.config.width = config.width ? calculateWidth(config.width, this.config.selector) - this.config.margin.left - this.config.margin.right
      : calculateWidth(defaults$1.width, this.config.selector) - this.config.margin.left - this.config.margin.right;
...
var SvgStreamgraphStrategy = (function (SvgStrategy$$1) {
  ...
  if ( SvgStrategy$$1 ) SvgStreamgraphStrategy.__proto__ = SvgStrategy$$1;
  SvgStreamgraphStrategy.prototype = Object.create( SvgStrategy$$1 && SvgStrategy$$1.prototype );
  SvgStreamgraphStrategy.prototype.constructor = SvgStreamgraphStrategy;
    ...
    SvgStreamgraphStrategy.prototype._loadConfigOnContext = function _loadConfigOnContext (config) {
        ...
        this.config.width = config.width ? calculateWidth(config.width, this.config.selector) - this.config.margin.left - this.config.margin.right
            : calculateWidth(defaults$2.width, this.config.selector) - this.config.margin.left - this.config.margin.right;
        ...
        this.config.x = {};
        this.config.x.type = config.x.type || defaults$2.axis.x.type;
        this.config.x.format = config.x.format || defaults$2.axis.x.format;
        this.config.y = {};
        this.config.y.type = config.y.type || defaults$2.axis.y.type;
        this.config.y.format = config.y.format || defaults$2.axis.x.format;
    };

  return SvgStreamgraphStrategy;
}(SvgStrategy$1));

var SvgStackedAreaStrategy = (function (SvgStrategy$$1) {
    ...
    if ( SvgStrategy$$1 ) SvgStackedAreaStrategy.__proto__ = SvgStrategy$$1;
    SvgStackedAreaStrategy.prototype = Object.create( SvgStrategy$$1 && SvgStrategy$$1.prototype );
...
var SvgSwimlaneStrategy = (function (SvgStrategy$$1) {
  ...
  if ( SvgStrategy$$1 ) SvgSwimlaneStrategy.__proto__ = SvgStrategy$$1;
  SvgSwimlaneStrategy.prototype = Object.create( SvgStrategy$$1 && SvgStrategy$$1.prototype );
  ...
  SvgSwimlaneStrategy.prototype._loadConfigOnContext = function _loadConfigOnContext (config) {
    ...
    this.config.width = config.width ? calculateWidth(config.width, this.config.selector) - this.config.margin.left - this.config.margin.right
      : calculateWidth(defaults$3.width, this.config.selector) - this.config.margin.left - this.config.margin.right;
    ...
    this.config.x = {};
    this.config.x.type = config.x.type || defaults$3.axis.x.type;
    this.config.x.format = config.x.format || defaults$3.axis.x.format;
    this.config.y = {};
    this.config.y.type = config.y.type || defaults$3.axis.y.type;
    this.config.y.format = config.y.format || defaults$3.axis.x.format;
...
var SvgGaugeStrategy = (function (SvgStrategy$$1) {
  function SvgGaugeStrategy(context) {
    SvgStrategy$$1.call(this, context);
  ...
  if ( SvgStrategy$$1 ) SvgGaugeStrategy.__proto__ = SvgStrategy$$1;
  SvgGaugeStrategy.prototype = Object.create( SvgStrategy$$1 && SvgStrategy$$1.prototype );
  ...
  SvgGaugeStrategy.prototype._loadConfigOnContext = function _loadConfigOnContext (config) {
    ...
    this.config.width = config.width ? calculateWidth(config.width, this.config.selector) - this.config.margin.left - this.config.margin.right
      : calculateWidth(defaults$4.width, this.config.selector) - this.config.margin.left - this.config.margin.right;
    ...
    this.config.label = config.label || defaults$4.label;
    //Just for testing purposes
    return this;
  };
...
var SvgNetworkgraphStrategy = (function (SvgStrategy$$1) {
  function SvgNetworkgraphStrategy(context) {
    SvgStrategy$$1.call(this, context);
  ...
  if ( SvgStrategy$$1 ) SvgNetworkgraphStrategy.__proto__ = SvgStrategy$$1;
  SvgNetworkgraphStrategy.prototype = Object.create( SvgStrategy$$1 && SvgStrategy$$1.prototype );
  SvgNetworkgraphStrategy.prototype.constructor = SvgNetworkgraphStrategy;
   ...
   * @param  {Object} config Config object
   */
  SvgNetworkgraphStrategy.prototype._loadConfigOnContext = function _loadConfigOnContext (config) {
    this.config = {};
    this.config.margin = config.margin || defaults$5.margin;
    this.config.selector = config.selector || defaults$5.selector;
    this.config.width = config.width ? calculateWidth(config.width, this.config.selector) - this.config.margin.left - this.config.margin.right
      : calculateWidth(defaults$5.width, this.config.selector) - this.config.margin.left - this.config.margin.right;
    this.config.height = config.height || defaults$5.height;

  };

  return SvgNetworkgraphStrategy;
}(SvgStrategy$1));
...
var SvgSunburstStrategy = (function (SvgStrategy$$1) {
  function SvgSunburstStrategy(context) {
    SvgStrategy$$1.call(this, context);
    var config = this.config;
    var radius = (Math.min(config.width, config.height) / 2) - 10;
    var translation = 'translate(' + config.width / 2 + ',' + (config.height / 2) + ')';
  ...
  if ( SvgStrategy$$1 ) SvgSunburstStrategy.__proto__ = SvgStrategy$$1;
  SvgSunburstStrategy.prototype = Object.create( SvgStrategy$$1 && SvgStrategy$$1.prototype );
  SvgSunburstStrategy.prototype.constructor = SvgSunburstStrategy;
   ...
   * @param  {Object} config Config object
   */
  SvgSunburstStrategy.prototype._loadConfigOnContext = function _loadConfigOnContext (config) {
    config = config || { events: {}, markers: {}, xaxis: {}, yaxis: {} };
...
Chart.prototype.toPNG = function toPNG (cb) {
    ...
    svgAsDataUri(d3.select(selector)._groups[0][0], {}, function (uri, err) {
        if (err) {
...
Chart.prototype._keepDrawingByReplacing = function _keepDrawingByReplacing (datum) {
    var datumType = datum.constructor;
    if (datumType === Array) {
        this.data = datum;
    }
...
var Networkgraph$1 = (function (Chart$$1) {
  function Networkgraph(data, config) {
    Chart$$1.call(this, data, config);
    var keys = Object.keys(defaults$5);
    this._initializeAPI(keys);
  }
